...
const rulea: ParserCallback = (sys, chars, phraseIndex, data) => {
  if (sys.state === ids.MATCH) {
    console.log("parse tree rule A matched");
  }
};
const ruleb: ParserCallback = (sys, chars, phraseIndex, data) => {
  if (sys.state === ids.MATCH) {
    console.log("parse tree rule B matched");
  }
};
const rulec: ParserCallback = (sys, chars, phraseIndex, data) => {
  if (sys.state === ids.MATCH) {
...
const asta: AstCallback = (state, chars, phraseIndex, phraseCount, data) => {
  if (state === ids.SEM_PRE) {
    console.log("AST rule A matched");
  }
};
const astb: AstCallback = (state, chars, phraseIndex, phraseCount, data) => {
  if (state === ids.SEM_PRE) {
    console.log("AST rule B matched");
  }
};
const astc: AstCallback = (state, chars, phraseIndex, phraseCount, data) => {
  if (state === ids.SEM_PRE) {

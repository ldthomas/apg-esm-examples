 ...
 *   ********************************************************************************* */
import { Api, Parser, utils, ids, type ParserCallback } from "apg-esm";
...
const sign: ParserCallback = (sysData, chars, phraseIndex, data) => {
...
const decimal: ParserCallback = (sysData, chars, phraseIndex, data) => {
  if (sysData.state === ids.MATCH) {
    console.log(
...
const exponent: ParserCallback = (sysData, chars, phraseIndex, data) => {
  if (sysData.state === ids.MATCH) {
    console.log(
